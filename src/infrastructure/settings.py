...
dict_continuous = {'naive': ['driver_client_distance', 'ride_distance', 'workshift_duration', 'workshift_rides_count',
                             'workshift_mean_rides_duration'],
                   'version_2': ['driver_client_distance', 'ride_distance', 'workshift_duration',
                                 'workshift_rides_count',
                                 'workshift_rides_prefered', 'workshift_mean_rides_duration',
                                 'workshift_sum_rides_duration',
                                 'workshift_rides_ratio'],
                   'version_3': ['driver_client_distance', 'ride_distance', 'workshift_duration',
                                 'workshift_prefered_duration',
...
continuous = dict_continuous[TRAINING_TYPE]
